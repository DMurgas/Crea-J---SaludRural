...
$consulta = "SELECT id_donacion,id_usuario,id_hospital,correo, `telefono`, `fecha`, medicamento, cantidad,estado FROM medicamentos";
...
<tbody>
                            ...
                            <td>
                                ...
                                if ($dat['estado'] == "Pendiente") {
                                    echo "<form action='bd/estado_medi.php' method='post'>";
